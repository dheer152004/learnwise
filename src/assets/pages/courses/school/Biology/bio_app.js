// bio_app.js — main controller for CurioLab Biology
...
function init() {
  buildSidebar();
  loadExperiment('osmosis');
}

function buildSidebar() {
  var sidebar = document.getElementById('sidebar');
  var sections = {
    'CELL BIOLOGY': ['osmosis', 'photosynthesis', 'mitosis'],
...
function openDrawerWith(key) {
  ...
  document.getElementById('reportBtn').textContent = '📋 AI Report';
...
// Override toggleMathsAI if called from old button
function toggleMathsAI() { toggleAiPanel(); }
